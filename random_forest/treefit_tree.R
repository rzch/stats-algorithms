...
#This script learns a decision tree using the tree package
...
treefit <- tree(is_wta~w_ace+w_df+w_1stPct+w_1stPctWon+w_2ndPctWon+l_ace+l_df+l_1stPct+l_1stPctWon+l_2ndPctWon, 
                 data = df_train)
